...
2. Extract all Mermaid.js diagram code blocks (`mermaid`). Validate that they are syntactically valid Mermaid diagrams without syntax errors.
...
5. Write your report in `C:\Users\hp\AssureCode\.agents\teamwork_preview_challenger_sprint7_2_gen2\handoff.md` with verdict (PASS or FAIL).
